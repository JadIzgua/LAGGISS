...
def shows_aug_img(aug_array, nb_aug):
    ...
    for i in range(nrows * ncols):
        ...
        if i < ncols:
            ...
            plt.imshow(ki.image.array_to_img(aug_array[i]), aspect='auto')
            ax[-1].set_xticks([])
            ax[-1].set_yticks([])
...
width = 224
img_dir = r"C:\PythonData\LAGGISS\Question_one"
save_folder = r"C:\PythonData\LAGGISS\Save_folder"

print("Starting")
preprocessing_duels(csv_path, width, img_dir, save_folder, 0.1)
print("Done")